...
function renderProducts(data) {
    ...
    data.forEach(row => {
        ...
        if (row.length >= 5) {
            ...
            // Create product HTML with table layout for price and button
            // Using inline table for maximum compatibility with Ariba
            const productHTML = `
                <div class="product-slide">
                    ...
                    <div class="product-info">
                        ...
                        <table style="width:100%; margin-top:auto; border-collapse:collapse; border-top:1px solid #eee; padding-top:8px;">
                            <tr>
                                <td style="text-align:left; vertical-align:middle; width:50%;">
                                    <div class="product-price">${price}</div>
                                </td>
                                <td style="text-align:right; vertical-align:middle; width:50%;">
                                    <a href="${productLink}" class="product-link" target="_blank">View Product</a>
                                </td>
                            </tr>
                        </table>
                    </div>
